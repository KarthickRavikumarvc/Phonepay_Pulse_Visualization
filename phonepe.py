...
st.set_page_config(page_title="Phonepe Pulse Data Visualization",
                   ...
                   menu_items={'About': """# This dashboard app is created by `KARTHICK!`
...
change_auth_query = "ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'Kerebdj@4';"
...
if selected == "Data Visualization":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'D:\Guvi Projects\Phonepe_Pulse\PhonePay_CSV\Statenames.csv')
            df1.State = df2
